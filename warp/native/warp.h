...
extern "C"
{
    ...
    WP_API void dense_vector_destroy_device(uint64_t id);

    WP_API int csr_ichol_device_buffer_size(uint64_t id);
    WP_API void csr_ichol_device(uint64_t id, float *L_values, void *buffer);
