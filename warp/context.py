...
class Runtime:
    ...
    def __init__(self):
        ...
        self.core.csr_destroy_device.argtypes = [ctypes.c_uint64]
        self.core.csr_destroy_device.restype = None
        self.core.dense_vector_destroy_device.argtypes = [ctypes.c_uint64]
        self.core.dense_vector_destroy_device.restype = None

        self.core.csr_ichol_device_buffer_size.argtypes = [ctypes.c_uint64]
        self.core.csr_ichol_device_buffer_size.restype = ctypes.c_int
        self.core.csr_ichol_device.argtypes = [ctypes.c_uint64, ctypes.c_void_p, ctypes.c_void_p]
        self.core.csr_ichol_device.restype = None

        self.core.csr_ilu_device_buffer_size.argtypes = [ctypes.c_uint64]
        ...
        self.core.csr_pd_solve_host.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
        self.core.csr_pd_solve_host.restype = None
        self.core.csc_pd_solve_host.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
        self.core.csc_pd_solve_host.restype = None
        self.core.csr_pardiso_pd_solve_host.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
        self.core.csr_pardiso_pd_solve_host.restype = None
        self.core.csc_pardiso_pd_solve_host.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p]
        self.core.csc_pardiso_pd_solve_host.restype = None
